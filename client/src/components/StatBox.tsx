    ...
    <div className="glass-card rounded-2xl p-6 hover:shadow-lg transition-all duration-300">
      <div className="flex items-center justify-between">
        <div className="flex-1">
          ...
          <p className="text-3xl font-bold text-foreground mt-2 mb-2">{value}</p>
          <div className="flex items-center">
            <span className={`text-sm font-medium ${changeColorClass} bg-muted px-2 py-1 rounded-lg`}>
              {change}
            </span>
            <span className="text-muted-foreground text-sm ml-2">{changeLabel}</span>
          </div>
        </div>
